(function (Modules) {
  ...
  ListEntry.prototype.entryTemplate = Hogan.compile(
    '<div class="list-entry">' +
      ...
      '/>' +
      '{{#button}}' +
        '<button type="button" class="fr-btn fr-btn--secondary input-list__button--remove">' +
  ...
  ListEntry.prototype.addButtonTemplate = Hogan.compile(
    '<button type="button" class="fr-btn fr-btn--secondary input-list__button--add">Add another {{listItemName}} ({{entriesLeft}} remaining)</button>'
  );
