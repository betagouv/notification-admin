  ...
  hierarchy.forEach((node, idx) => {
    ...
    result += `
      <div class="govuk-checkboxes__item template-list-item template-list-item-with-checkbox template-list-item-without-ancestors">
        ...
        <a href="/services/6658542f-0cad-491f-bec8-ab8457700ead/templates/all/folders/3d057d9a-51fc-45ea-8b63-0003206350a6" class="fr-link template-list-${node.type === 'folder' ? 'folder' : 'template'}">
